...
> 对 prompt 的每一行问自己：**"删掉它会导致模型犯错吗？"** 如果不会，就是噪音，应该删掉。
>
...
### excessive-caps — ALL-CAPS 强调词密度过高
...
### suggestive-language — 建议性语言用于需要行动的场景
...
### contradictory-instructions — 指令之间矛盾
...
### negative-only-instructions — 只有否定没有正向替代
...
### style-mismatch — prompt 风格与期望输出不一致
